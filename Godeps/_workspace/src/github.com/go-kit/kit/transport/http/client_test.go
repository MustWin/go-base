...
import (
	...
	"github.com/MustWin/go-base/Godeps/_workspace/src/golang.org/x/net/context"

	httptransport "github.com/MustWin/go-base/Godeps/_workspace/src/github.com/go-kit/kit/transport/http"
)
